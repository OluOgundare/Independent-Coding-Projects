...
def stock_info(stock, period, SDs, startDate, endDate):
    ...
    # Plot the close price of the TSLA
    ...
    stock_image_4 = stock + "-BuySell.jpeg"

    return stock_image_1, stock_image_2, stock_image_3, stock_image_4, totalProfitPerShare, company_name, company_website

# Define the folder to store the uploaded images
def remove_images():
    for file in os.listdir('static/images'):
        if file.endswith('.jpeg'):
            os.remove(r"C:/Users/oluwa/OneDrive/Desktop/Citadel Externship/Final_Project/static/images/" + file) 
